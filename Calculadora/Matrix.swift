...
struct Matrix {
    static let firstSectionData: [KeybaoardButton] = [
    ...
    static let secondSectionData: [KeybaoardButton] = [
    ...
    static let secondSectionGrid: (CGFloat) -> [GridItem] = { width in
        return [
            GridItem(.flexible(minimum: width * 2), spacing: 0), // Es width * 2 porque es la tecla 0.
